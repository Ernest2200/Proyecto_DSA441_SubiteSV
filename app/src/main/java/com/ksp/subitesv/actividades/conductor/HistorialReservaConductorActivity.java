...
import com.ksp.subitesv.adapters.AdaptadorHistorialReservaConductor;
...
public class HistorialReservaConductorActivity extends AppCompatActivity {

    private RecyclerView mRecyclerView;
    private AdaptadorHistorialReservaConductor mAdapter;
    private AuthProveedores mAuthProveedores;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_historial_reserva_conductor);
    ...
    protected void onStart() {
        ...
        Query query = FirebaseDatabase.getInstance().getReference().child("HistorialReserva").orderByChild("idConductor").equalTo(mAuthProveedores.obetenerId());
        ...
        mAdapter = new AdaptadorHistorialReservaConductor(opciones, HistorialReservaConductorActivity.this);
