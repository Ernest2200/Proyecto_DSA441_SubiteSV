...
public class DetalleHistorialReservaConductorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detalle_historial_reserva_conductor);
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            if (snapshot.exists()){
                                ...
                                if (snapshot.hasChild("imagen")){
                                    ...
                                    Picasso.with(DetalleHistorialReservaConductorActivity.this).load(imagen).into(mCircleImage);
                                }
                            }
                        }
